...
import { Calculator, CheckCircle2, FileUp, Info, Loader2 } from "lucide-react";
...
export function FieldInput({ field, data, error, options, onChange }: Props) {
  ...
  return (
    <div>
      ...
      {field.hint && !error && <p className="mt-1.5 text-[12px] leading-snug text-slate-500">{field.hint}</p>}
