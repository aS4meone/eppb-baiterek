    ...
    <form onSubmit={submit} className="flex max-w-xl gap-2">
      <div className="relative flex-1">
        ...
        <input
          ...
          placeholder="Чем занимается ваш бизнес? Что нужно профинансировать?"
      ...
      <button
        type="submit"
        className="flex items-center gap-2 rounded-2xl bg-gold-500 px-5 py-3.5 text-[14px] font-extrabold text-brand-950 transition hover:bg-gold-400"
      >
        <Sparkles size={16} />
        Подобрать
      </button>
